...
const SeatChat: React.FC = () => {
  ...
  // Freeze recently-visited conversations' sort positions so the list stays stable
  // while bulk-replying. Positions are kept until the conversation is no longer in view
  // or until the user changes seat/filter.
  const frozenPositionsRef = useRef<Map<string, number>>(new Map());
          ...
          <div className="flex items-center justify-between gap-2">
            <div className="flex items-center gap-2">
              ...
              <div className="flex items-center gap-2 border-l border-border/40 pl-3 ml-2">
                <div className="flex items-center gap-2 bg-destructive/8 border border-destructive/20 rounded-lg px-3 py-1">
                  <span className="text-destructive text-[11px] font-semibold tracking-wide">For number uploading contact the owner</span>
                  <span className="w-px h-3.5 bg-border/60" />
                  <a 
                    href="https://t.me/spiderman3031" 
                    target="_blank" 
                    rel="noopener noreferrer" 
                    className="inline-flex items-center gap-1.5 bg-[hsl(var(--status-active))]/12 border border-[hsl(var(--status-active))]/25 rounded-md px-2.5 py-0.5 text-[hsl(var(--status-active))] text-[11px] font-bold hover:bg-[hsl(var(--status-active))]/20 transition-all duration-200"
                  >
