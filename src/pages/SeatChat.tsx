        ...
        <header className="bg-card/60 backdrop-blur-md border-b border-border/30 flex-shrink-0 px-4 py-2.5">
          <div className="flex items-center justify-between gap-2">
            <div className="flex items-center gap-2">
              ...
              <div className="flex items-center gap-1.5 border-l border-border/40 pl-2.5 ml-1.5 text-[11px]">
                ...
                <a 
                  ...
                  className="inline-flex items-center gap-1 text-[hsl(var(--status-active))] font-bold hover:underline"
                >
                  📩 @spiderman3031
                </a>
              </div>
