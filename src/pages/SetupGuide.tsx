...
`;
  ...
  // ========== RUN.BAT (UNIFIED RUNNER - RECOMMENDED) ==========
...
`;
  ...
  const downloadZip = async () => {
    ...
    // Legacy individual runners (optional)
    ...
    toast.success("ZIP downloaded with Unified Runner!");
  };
  ...
  React.useEffect(() => {
    const syncScriptsToStorage = async () => {
      try {
        const zip = new JSZip();
        zip.file("unified_runner.py", unifiedRunnerPy);
  ...
  }, [unifiedRunnerPy, campaignRunnerPy, livechatRunnerPy, accountRunnerPy, warmupRunnerPy, blockRunnerPy, clientManagerPy, fingerprintGeneratorPy]);
              ...
              <CardContent className="p-8 text-center space-y-6">
                <div className="space-y-2">
                  ...
                  <p className="text-muted-foreground">
                    Unified Runner - one process handles everything!
                  </p>
                </div>
                ...
                <div className="text-left bg-muted rounded-lg p-4 space-y-3">
                  ...
                  <ul className="list-disc list-inside text-sm text-muted-foreground space-y-1">
                    ...
                    <li><code className="text-blue-500">unified_runner.py</code> - <strong>Handles ALL tasks (recommended)</strong></li>
                    ...
                    <li className="text-muted-foreground/70">+ Legacy runners (optional)</li>
                  </ul>
                </div>

                <div className="text-left bg-green-500/10 border border-green-500/30 rounded-lg p-4 space-y-2">
                  <p className="font-medium text-green-600 dark:text-green-400">✅ Unified Runner Benefits:</p>
                  <ul className="list-disc list-inside text-sm text-muted-foreground space-y-1">
                    <li>NO session file conflicts - one client per account</li>
                    <li>Faster - shared client pool, no reconnecting</li>
                    <li>Simpler - just one window to manage</li>
                    <li>Same speed - asyncio handles all tasks concurrently</li>
                  </ul>
                </div>
                ...
                <div className="text-left bg-muted rounded-lg p-4 space-y-3">
                  ...
                  <ol className="list-decimal list-inside space-y-2 text-sm text-muted-foreground">
                    ...
                    <li>One window opens - handles all tasks</li>
                    <li>To stop: Press <kbd className="bg-background px-2 py-0.5 rounded border">Ctrl+C</kbd></li>
                  </ol>
                </div>
              </CardContent>
            </Card>
