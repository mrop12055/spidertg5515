...
async def main_loop():
    ...
    while RUNNING:
        try:
            ...
            # Server returns tasks based on batch_size from app_settings
            ...
            if not tasks:
                ...
                elif consecutive_empty % 6 == 0:  # Every ~minute (6 x 10s)
            ...
            # Disconnect clients after batch to save resources
